-- TODO
-- 2- [ ]An episode can have the season id of a different series FIX this with trigger in DDL
-- 5- [ ]User Interests
-- 6- [ ]Database Error Checks With Triggers
-- -- 6-1-[ ] Correct Email Syntax With Error Code
-- -- 6-2-[ ] Correct Password Syntax with Error Code
-- -- 6-3-[ ] Correct Username Syntax with Error Code
-- -- 6-4-[ ] Correct Email Syntax with Error Code
-- 7- [x]Make emails Lower Case
